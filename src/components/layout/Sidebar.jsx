...
const NAV_CONFIG = {
  ...
  affiliate: [
    ...
    { label: 'Store Onboarding', path: '/dashboard/stores/onboard',        icon: Building2 },
    { label: 'Sovereign_Market_Incubator_System', icon: BriefcaseBusiness, children: [
      { label: 'Sovereign_Market_Incubator_System request', path: '/dashboard/affiliate/incubator-request', icon: ClipboardList },
      { label: 'Sovereign_Market_Incubator_System remote request', path: '/dashboard/affiliate/incubator-remote-request', icon: Radio },
      { label: 'Sovereign_Market_Incubator_System prequalified business owners', path: '/dashboard/affiliate/incubator-prequalified-businesses', icon: Users },
      { label: 'Sovereign_Market_Incubator_System prequalified pool', path: '/dashboard/affiliate/incubator-prequalified-pool', icon: CheckCircle2 },
      { label: 'Sovereign_Market_Incubator_System lookup', path: '/dashboard/affiliate/incubator-lookup', icon: Search },
